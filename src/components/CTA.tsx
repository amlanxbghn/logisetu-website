    ...
    return (
        <div className='pb-[250px] pt-[120px] relative overflow-clip'>
            <div className="container relative">
                ...
                <div className="max-w-4xl lg:max-w-7xl mx-auto bg-blue-600 rounded-3xl p-16 md:p-20 lg:p-28 text-center relative overflow-hidden z-5">
                    ...
                    <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-[radial-gradient(circle_at_top_right,#2463EB,transparent_40%)] opacity-50"></div>
                    ...
                    <div className="absolute bottom-0 left-0 w-1/2 h-1/2 bg-[radial-gradient(circle_at_bottom_left,#2463EB,transparent_40%)] opacity-50"></div>
            ...
            <div className="absolute h-[375px] w-[750px] sm:w-[1536px] sm:h-[768px] lg:w-[3200px] lg:h-[1200px] rounded-[100%] bg-black left-1/2 -translate-x-1/2 border border-white/15 bg-[radial-gradient(closest-side,#000_95%,#222222)] top-[calc(100%-96px)] sm:top-[calc(100%-120px)] z-5">
            </div>
