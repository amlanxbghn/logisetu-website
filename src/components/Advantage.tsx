...
const Advantage = () => {
    return (
        <div className="container mb-32">
            <h2 className="text-4xl md:text-5xl font-bold pb-1.5 mb-1.5 tracking-tight bg-gradient-to-b from-white via-white to-[#111111] text-transparent bg-clip-text">
                Competitive Advantage
            </h2>
            <p className="mb-16 text-zinc-400 text-md md:text-lg font-medium">
