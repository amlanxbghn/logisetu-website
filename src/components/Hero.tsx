  ...
  return (
    <div className="relative py-36">
      <div className="container">
        ...
        <h1 className="text-center text-5xl md:text-6xl lg:text-7xl leading-tight md:leading-tight lg:leading-tight md:font-medium max-w-[1200px] mx-auto mb-6 md:mb-12">
